...
class Marker:
    def __init__(self, dict_type = aruco.DICT_4X4_50, thresh_constant = 1):
        self.aruco_dict = aruco.Dictionary(aruco.DICT_6X6_250, 6)
        ...
        self.mtx, self.dist = Marker.calibrate(gray, objpoints, imgpoints)
    ...
    def calibrate():
        ...
        def calibrate(gray, objpoints, imgpoints):
